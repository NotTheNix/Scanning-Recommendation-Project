...
Saves: Models/ml_models/saved/xgboost_pipeline.pkl
       Models/ml_models/saved/xgb_phone_encoder.pkl

Install: pip install xgboost scikit-learn joblib pandas numpy
"""
...
MODEL_SAVE   = os.path.join(SAVE_DIR, "xgboost_pipeline.pkl")
ENCODER_SAVE = os.path.join(SAVE_DIR, "xgb_phone_encoder.pkl")
...
def train():
    ...
    importances = sorted(
        zip(X_all.columns, xgb_model.feature_importances_),
    ...
    joblib.dump(xgb_pipeline, MODEL_SAVE)
